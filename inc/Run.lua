...
hso = Token:match("(%d+)")
redis:set(hso..":VERSION",2.9)
redis:set(hso..":SUDO_ID:",SUDO_USER)
redis:set(hso..":DataCenter:",'German')
redis:set(hso..":UserNameBot:",BOT_User)
redis:set(hso..":NameBot:",BOT_NAME)
redis:hset(hso..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3hso_INSTALL","Yes")
...
hso = Token:match("(%d+)")
our_id = tonumber(hso)
Apihso = redis:get(hso..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(hso..":UserNameBot:")
SUDO_ID = tonumber(redis:get(hso..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(hso..'username:'..SUDO_ID).username
version = redis:get(hso..":VERSION")
DataCenter = redis:get(hso..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..hso..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..Apihso..'\027[0;32m\n'
...
if not redis:get(hso..":Check_Bot:"..W) then
Rgz,res=https.request(Apihso..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(hso..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(hso..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(hso..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(hso..'group:add'..msg.chat_id_) then 
...
and redis:get(hso.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(hso..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(hso..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(hso..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end
...
if not redis:get(hso..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(hso..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(hso..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 
...
msg.TheRankCmd = redis:get(hso..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(hso..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(hso..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hso..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(hso..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(hso..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hso..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(hso..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(hso..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hso..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(hso..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(hso..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hso..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(hso..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(hso..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(hso..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(hso..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(hso..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(hso..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(hso..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(hso..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(hso..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(hso..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(hso..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(hso..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(hso.."lock_Add"..msg.chat_id_) then
...
if redis:get(hso.."lock_check"..msg.chat_id_) and not redis:get(hso..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(hso..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(hso..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(hso..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.hso then 
if msg.text and ScriptFile.ihso then
Xhso = ScriptFile.hso
local list = redis:hgetall(hso..":AwamerBotArray:"..msg.chat_id_)
for hso2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(hso2) then 
local amrr = {Text:match(hso2)}
local AmrOld = redis:hgetall(hso..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
if ScriptFile.dhso then
if ScriptFile.dhso(msg) == false then
return false
end
...
if Plug.hso then 
if msg.text and Plug.ihso then
for k, hso in pairs(Plug.hso) do
if msg.text:match(hso) then
local GetMsg = Plug.ihso(msg,{msg.text:match(hso)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",hso.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source hso")
end 

end
else
print("The File Script.lua Not Runing in The Source hso")
end
end
...
redis:srem(hso..'users',msg.sender_user_id_)
end
...
if redis:get(hso..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(hso..":propin"..msg.chat_id_)
...
if redis:get(hso..'group:add'..data.chat_.id_) then
redis:set(hso..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(hso..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(hso..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(hso..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
hso..'group:name'..k,IDS.Title,
hso..'num_msg_max'..k,5,
hso..'group:add'..k,true,
hso..'lock_link'..k,true,
hso..'lock_spam'..k,true,
hso..'lock_webpage'..k,true,
hso..'lock_markdown'..k,true,
hso..'lock_flood'..k,true,
hso..'lock_bots'..k,true,
hso..'mute_forward'..k,true,
hso..'mute_contact'..k,true,
hso..'mute_document'..k,true,
hso..'mute_inline'..k,true,
hso..'lock_username'..k,true,
hso..'replay'..k,true
)
redis:sadd(hso..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(hso..'username:'..ID,'username',user)
redis:sadd(hso..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(hso..'username:'..ID,'username',user)
redis:sadd(hso..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(hso..'username:'..ID,'username',user)
redis:sadd(hso..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(hso..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(hso..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(hso..'username:'..data.user_.id_).username
...
redis:hset(hso..'username:'..data.user_.id_,'username',USERNAME)
end 
end
